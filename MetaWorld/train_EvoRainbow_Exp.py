...
from EvoRainbow_Exp_sac_agent import sac_agent
...
if __name__ == '__main__':
    ...
    name = "Rainbow_Exp_k" +str(args.EA_tau)+"_CEM_"+ str(args.damp) + "_"+ str(args.damp_limit)+"_SAC_Env_"+ str(args.pop_size) + "_" + str(args.batch_size) + "_" + str(args.env_name) + "_steps_" + str(args.total_timesteps)
